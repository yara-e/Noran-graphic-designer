 ...
 <div className="absolute top-16 right-0 w-1/3 pr-12  bg-texture">
      ...
      <div className="relative z-10 flex flex-col items-center select-none w-full">
        ...
        <div className="flex items-center ">
          <div className="relative w-16 h-16 md:w-60 md:h-60 -mr-8 -mt-10  md:-mr-20 md:-mt-30 z-20 ">
            <Image src="/like (1).png" alt="3D Like" fill className="object-contain drop-shadow-[0_25px_25px_rgba(0,0,0,0.8)]" />
          </div>
          <h2 className="font-main text-[#e21c61] text-[60px] md:text-[210px] fade-bottom-subtle">Social</h2>
        </div>

        {/* MEDIA ROW - Heart attached to 'a' */}
        <div className="flex items-center -mt-4 ml-20 md:-mt-12 md:ml-100">
          <h2 className="font-main text-gray-400 text-[60px] md:text-[210px] opacity-95 fade-bottom-subtle">Media</h2>
          <div className="relative w-16 h-16 md:w-60 md:h-60 -ml-4 mt-5 md:mt-20 md:-ml-15 z-20">
            <Image src="/love (1).png" alt="3D Heart" fill className="object-contain drop-shadow-[0_25px_25px_rgba(0,0,0,0.8)]" />
          </div>
        </div>
